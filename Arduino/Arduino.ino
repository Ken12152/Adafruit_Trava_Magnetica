/////////////////////////////////////////////////////////
// logica que limpa o EEPROM do Arduino deixei comentado
/////////////////////////////////////////////////////////


#include <A2a.h>  // esse biblioteca facilita comunicacao I2c que usa <Wire.h>
...
// se botao do adafruit foi pressionado
bool unlockFromAdafruit = false;
...
void setup()
{
  // configuracao sobre comunicacao com ESP
  // Inicia comunicacao com ESP
  ConexaoComESP.begin(address);
  
  // callback chamado quando receber dados pelo esp (quando for pressionado o botao no adafruit)
  ConexaoComESP.onReceive(receiveData);
...
void loop()
{
  ...
  if(programMode) {
    ...
    // Normal mode, blue Power LED is on, all others are off and Make sure Door is Locked
    normalModeOn();
  }
